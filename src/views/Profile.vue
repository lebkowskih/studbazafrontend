    ...
    <div class="row justify-content-md-center">
      <div class="col-8">
        ...
        <div class="card" style="margin: 5px">
          <button id="cardbutton" class="button_post" data-bs-toggle="modal" data-bs-target="#addpostmodal">
              ...
              <div class="modal-header">
                <div class="container">
                  <section class="post">
                    ...
                    <form id="form" action="#">
                      <textarea placeholder="O czym myślisz?" spellcheck="false" required
        ...
        <div class="card" style="margin: 5px" v-for="(post, postindex) in mineposts" :key="postindex">
          <div class="card-body">
            ...
            <button data-bs-toggle="modal" data-bs-target="#editpostmodal" class="btnedit">
                  ...
                  <div class="modal-header">
                    <div class="container">
                      <section class="post">
                        ...
                        <form id="form">
                          <textarea spellcheck="false" required v-model="editcontent">{{ this.addcontent }}</textarea>
                          <button @click="updatePost(postindex)" class="formbutton">
                            Opublikuj
                          </button>
                        </form>
                      </section>
