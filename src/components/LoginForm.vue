    ...
    <body>
        <Form :validation-schema="schema">
            <div class="form-group">
                ...
                <Field name="loginEmail" type="email" class="form-control" id="loginEmail" placeholder="Wprowadź e-mail"
                    v-model="loginEmail" />
            ...
            <div class="form-group">
                ...
                <Field name="loginPassword" type="password" class="form-control" id="loginPassword"
                    placeholder="Wprowadź hasło" v-model="loginPassword" />
